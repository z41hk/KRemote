...
**Latest: v0.11.1 (Windows x64 + Linux x64)**
- **Windows**: Download `KRemote-v0.11.1-windows.zip`, extract, and run `kremote.exe`
- **Linux**: Download `KRemote-v0.11.1-linux-x64.tar.gz`, extract, and run `./kremote`
- No installation required (portable)
- **New in v0.11.1**: RDP xrdp compatibility fix — disable NLA (CredSSP) for xrdp servers, TLS-only connection support
- **v0.11.0**: RDP protocol foundation — IronRDP integration complete, protocol connection testing, domain field support, framebuffer API ready (UI coming next)
- **v0.10.0**: Dynamic window title (shows active connection name), delete confirmation dialogs for connections/folders
...
- [x] Session tabs (multiple SSH terminals in tabbed interface)
